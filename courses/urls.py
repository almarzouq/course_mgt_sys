...
urlpatterns = [
    ...
    url(r'^course/announcement/(?P<pk>\d+)/edit/$',
        views.CourseAnnouncementEdit.as_view(), name='edit_course_announcment',),
    ...
    url(r'^course/(?P<course_id>\d+)/lecture/$',
        views.instructor_lecture, name='lecture_create',),
    url(r'^course/(?P<course_id>\d+)/lecture/(?P<lecture_id>\d+)/',
        views.lecture_details, name='lecture_details',),
    url(r'^course/(?P<course_id>\d+)/lecture/list/$',
